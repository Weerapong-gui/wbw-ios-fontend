...
final class AppStoreConfigTests: XCTestCase {
    ...
    ///
    /// รายการปลายทางคือ `th.ac.mfu.wbwSwift` ซึ่งเป็น record ของ WBW เอง และเป็นที่ที่ใบตีกลับ
    /// 5.1.1(iv) ของ 1.0 (12) ค้างอยู่ · เคยสลับไป `th.ac.mfu.su.clubfair` (record ของ
    /// SU Club Fair) เมื่อ 2026-08-25 แล้วกลับมาวันเดียวกัน — ตอบ Resolution Center ของรายการ
    /// ไหนก็ต้องอัป build เข้ารายการนั้น จะข้ามไปรายการอื่นไม่ได้
    ///
    ...
    func testTheBundleIdentifierPointsAtTheIntendedAppStoreRecord() throws {
        ...
        XCTAssertTrue(yml.contains("PRODUCT_BUNDLE_IDENTIFIER: th.ac.mfu.wbwSwift\n"),
