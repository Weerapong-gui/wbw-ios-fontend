...
Run: `cd ~/Student-Union-Server && WBW_DB_TESTS=1 go test ./internal/repository/ -run SOS -v`
...
Run: `cd ~/Student-Union-Server && go test ./internal/repository/ -run SOS -v`
...
Run: `cd ~/Student-Union-Server && go test ./internal/handler/ -run SOS -v`
