...
**Files:**
- Modify: `WBW/Info.plist`, `WBW/Info-Debug.plist`, `WBW/PrivacyInfo.xcprivacy`, `WBWTests/AppStoreConfigTests.swift`, `WBW/LoginView.swift` (or wherever login succeeds)
