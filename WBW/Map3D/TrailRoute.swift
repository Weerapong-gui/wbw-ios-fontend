...
///
/// **ชุดที่ส่งไปกับ iOS ถูกตัดสั้นกว่าต้นทาง** — แทร็กเต็มของผู้จัดงานมี 750 จุด (~8.3 กม.)
/// ไปจบทางตะวันตกหลัง มฟล. · ชุดนี้ตัดที่ทางแยกถนน 3303 ตามที่ Park ชี้บนแผนที่เมื่อ 2026-08-24
/// เหลือ 491 จุด ~5.0 กม. จบที่ (20.05671, 99.90875) · **ฝั่ง Android ยังเป็นเส้นเต็ม** สองแอป
/// จึงวาดเส้นคนละความยาวจนกว่าจะตัดอีกฝั่ง — ที่มาของตัวเลขทั้งหมดอยู่ใน `_comment` ของไฟล์ JSON
///
