...
/// เส้นทางเดินของงาน อบมากับแอป — **ไฟล์เดียวกับที่ Android ใช้**
/// (`app/src/main/res/raw/route_wbw.json` ของ repo Student-Union-WBW-Andriod ก๊อปมาทั้งใบ)
///
/// เป็นค่าคงที่ ไม่ใช่ของที่ยิงมาจากเซิร์ฟเวอร์ ตามเหตุผลที่ต้นทางเขียนไว้: เส้นทางไม่เปลี่ยน
/// ระหว่างงาน การถาม routing service ทุกครั้งที่เปิดแอปคือการจ่ายโควตาเพื่อให้ได้ 8.3 กม.
/// เดิมกลับมา — และที่สำคัญกว่านั้น เส้นต้องวาดได้บนเครื่องที่ไม่มีสัญญาณกลางดอย
/// ซึ่งเป็นสภาพที่แอปนี้ถูกใช้จริง
///
