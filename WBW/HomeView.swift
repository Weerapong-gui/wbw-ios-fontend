...
struct HomeView: View {
    ...
    var body: some View {
        ...
        // ดอกไม้กินที่ที่เหลือทั้งหมดโดยตั้งใจ — บนจอกว้างจึงต้องมีเพดาน ไม่งั้นมันกลายเป็น
        // วอลเปเปอร์แทนที่จะเป็นตัวบอกสถานะ · หนีบทั้งคอลัมน์ ไม่ใช่หนีบเฉพาะดอกไม้
        // เพราะบรรทัดทักทายกับคำอธิบายท้ายจอต้องอยู่ในความกว้างเดียวกันกับมัน
        .contentColumn(.card)
