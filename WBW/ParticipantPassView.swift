    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView {
                ...
                .padding(.bottom, 16)
                .tabBarClearance()
                // บัตรเป็น **วัตถุที่มีสัดส่วนของตัวเอง** ไม่ใช่การ์ดที่ยืดได้ — กว้างเท่าจอ iPad
                // แล้วอ่านเป็นบัตรที่ถูกยืด ไม่ใช่บัตรที่ใหญ่ขึ้น · คอลัมน์เดียวกันครอบปุ่ม SOS
                // ด้วยโดยตั้งใจ เพราะความกว้างของปุ่มมาจากที่ที่มันถูกวาง (ดู `SOSButton.wideBody`)
                .contentColumn(.pass)
            }
